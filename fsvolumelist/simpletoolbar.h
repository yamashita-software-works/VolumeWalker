...
public:
	HWND CreateSimpleToolbar(HWND hWndParent,TBBUTTON *tbButtons,int cButtons,DWORD dwFlags=0/*reserved*/)
	{
	    ...
	    HWND hWndToolbar = CreateWindowEx(0, TOOLBARCLASSNAME, NULL, 
		    WS_CHILD | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CCS_NODIVIDER | CCS_TOP | 
			TBSTYLE_LIST | TBSTYLE_FLAT | TBSTYLE_AUTOSIZE | TBSTYLE_TOOLTIPS | (Transparent ? TBSTYLE_TRANSPARENT : 0),
			0, 0, 0, 0,
