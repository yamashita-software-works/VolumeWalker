	...
	)
{
	...
	if( dwResult == ERROR_INSUFFICIENT_BUFFER )
	{
		...
		{
			dwResult = ERROR_SUCCESS; // This volume is Virtual Disk, however no return data.
		}
	}
	return dwResult;
}
	...
	)
{
	...
	BOOL bResult = FALSE;
	HANDLE Handle;
	OpenFile_W(&Handle,NULL,NtVolumeRootDir,FILE_READ_ATTRIBUTES|SYNCHRONIZE,
